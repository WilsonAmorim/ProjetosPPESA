...
def main(page: ft.Page):
    ...
    txt_erro = ft.Container(ft.Text('Erro ao salvar o produto!'), visible=False, bgcolor=ft.colors.RED, alignment=ft.alignment.center)
    txt_acerto = ft.Container(ft.Text('Produto salvo com sucesso!'), visible=False, bgcolor=ft.colors.GREEN, alignment=ft.alignment.center)
